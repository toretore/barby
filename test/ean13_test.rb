...
class EAN13Test < Barby::TestCase
  ...
  describe 'validations' do
    ...
    it "should raise an exception when data is invalid" do
      _ { EAN13.new('123') }.must_raise(ArgumentError)
    end
  ...
  describe 'data' do
    ...
    it "should have the expected numbers" do
      _(@code.numbers).must_equal @data.split(//).map{|s| s.to_i }
    end

    it "should have the expected odd_and_even_numbers" do
      _(@code.odd_and_even_numbers).must_equal [[2,4,1,7,5,0], [1,6,8,6,7,0]]
    end

    it "should have the expected left_numbers" do
                                   #0=second number in number system code
      _(@code.left_numbers).must_equal [0,7,5,6,7,8]
    end

    it "should have the expected right_numbers" do
      _(@code.right_numbers).must_equal [1,6,4,1,2,5]#5=checksum
    end

    it "should have the expected numbers_with_checksum" do
      _(@code.numbers_with_checksum).must_equal @data.split(//).map{|s| s.to_i } + [5]
    end

    it "should have the expected data_with_checksum" do
      _(@code.data_with_checksum).must_equal @data+'5'
    end

    it "should return all digits and the checksum on to_s" do
      _(@code.to_s).must_equal '0075678164125'
    end
  ...
  describe 'checksum' do
    ...
    it "should have the expected weighted_sum" do
      _(@code.weighted_sum).must_equal 85
      @code.data = '007567816413'
      _(@code.weighted_sum).must_equal 88
    end

    it "should have the correct checksum" do
      _(@code.checksum).must_equal 5
      @code.data = '007567816413'
      _(@code.checksum).must_equal 2
    end

    it "should have the correct checksum_encoding" do
      _(@code.checksum_encoding).must_equal '1001110'
    end
  ...
  describe 'encoding' do
    ...
    it "should have the expected checksum" do
      _(@code.checksum).must_equal 9
    end

    it "should have the expected checksum_encoding" do
      _(@code.checksum_encoding).must_equal '1110100'
    end

    it "should have the expected left_parity_map" do
      _(@code.left_parity_map).must_equal [:odd, :even, :odd, :even, :odd, :even]
    end

    it "should have the expected left_encodings" do
      _(@code.left_encodings).must_equal %w(0110001 0100111 0011001 0100111 0111101 0110011)
    end

    it "should have the expected right_encodings" do
      _(@code.right_encodings).must_equal %w(1000010 1100110 1100110 1000010 1110010 1110100)
    end

    it "should have the expected left_encoding" do
      _(@code.left_encoding).must_equal '011000101001110011001010011101111010110011'
    end

    it "should have the expected right_encoding" do
      _(@code.right_encoding).must_equal '100001011001101100110100001011100101110100'
    end

    it "should have the expected encoding" do
                               #Start   Left                                           Center    Right                                          Stop
      _(@code.encoding).must_equal '101' + '011000101001110011001010011101111010110011' + '01010' + '100001011001101100110100001011100101110100' + '101'
    end
  ...
  describe 'static data' do
    ...
    it "should have the expected start_encoding" do
      _(@code.start_encoding).must_equal '101'
    end

    it "should have the expected stop_encoding" do
      _(@code.stop_encoding).must_equal '101'
    end

    it "should have the expected center_encoding" do
      _(@code.center_encoding).must_equal '01010'
    end
