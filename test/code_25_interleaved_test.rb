...
class Code25InterleavedTest < Barby::TestCase
  ...
  it "should have the expected digit_pairs" do
    _(@code.digit_pairs).must_equal [[1,2],[3,4],[5,6],[7,0]]
  end

  it "should have the expected digit_encodings" do
    _(@code.digit_encodings).must_equal %w(111010001010111000 111011101000101000 111010001110001010 101010001110001110)
  end

  it "should have the expected start_encoding" do
    _(@code.start_encoding).must_equal '1010'
  end

  it "should have the expected stop_encoding" do
    _(@code.stop_encoding).must_equal '11101'
  end

  it "should have the expected data_encoding" do
    _(@code.data_encoding).must_equal "111010001010111000111011101000101000111010001110001010101010001110001110"
  end

  it "should have the expected encoding" do
    _(@code.encoding).must_equal "101011101000101011100011101110100010100011101000111000101010101000111000111011101"
  end
  ...
  it "should return the expected encoding for parameters passed to encoding_for_interleaved" do
    ...
    _(@code.encoding_for_interleaved(w,n,n,w,n,n,n,n,w,w)).must_equal '111010001010111000'
    #                              3 4 3 4 3 4 3 4 3 4  digits 3 and 4
    #                              B S B S B S B S B S  bars and spaces
    _(@code.encoding_for_interleaved(w,n,w,n,n,w,n,n,n,w)).must_equal '111011101000101000'
  end
  ...
  describe "with checksum" do
    ...
    it "should have the expected digit_pairs_with_checksum" do
      _(@code.digit_pairs_with_checksum).must_equal [[1,2],[3,4],[5,6],[7,0]]
    end

    it "should have the expected digit_encodings_with_checksum" do
      _(@code.digit_encodings_with_checksum).must_equal %w(111010001010111000 111011101000101000 111010001110001010 101010001110001110)
    end

    it "should have the expected data_encoding_with_checksum" do
      _(@code.data_encoding_with_checksum).must_equal "111010001010111000111011101000101000111010001110001010101010001110001110"
    end
